...
public class GeriFark extends JPanel {
	...
	public static double GF(String fonk, double xSifir, double dx){
		// xEksiBir = xSifir - dx
		double xEksiBir = xSifir - dx;
		double fxEksiBir, fxSifir;
