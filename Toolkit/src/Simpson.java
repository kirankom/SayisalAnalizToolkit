...
public class Simpson extends JPanel {
	...
	public Simpson() {
		...
		lblADeeri.setBounds(32, 100, 103, 14);
		add(lblADeeri);
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				son = S(fonk, altSinir, ustSinir, bolmeSayisi);
	...
	public static double S(String fonk, double aSinir, double uSinir, double bolmeSayisi){	
		double h;
	    double Sonuc,s1,s2;
	    double x=aSinir;
